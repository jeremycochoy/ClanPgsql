...
/// \brief <p>ClanLib postgreSQL database connection library.</p>
//! Global=Pgsql
...
#pragma managed(pop)
	...
	#if !defined(_DEBUG)
		#if defined(CL_DLL)
			#pragma comment(lib, "clanPgsql-dll.lib")
			#pragma comment(lib, "libpq-dll.lib")
#elif defined(_DLL)
			#pragma comment(lib, "clanSqlite-static-mtdll.lib")
			#pragma comment(lib, "libpq-static-mtdll.lib")
		#else
			#pragma comment(lib, "clanSqlite-static-mt.lib")
			#pragma comment(lib, "libpq-static-mt.lib")
		#endif
	#else
		#if defined(CL_DLL)
			#pragma comment(lib, "clanSqlite-dll-debug.lib")
			#pragma comment(lib, "libpq-dll-debug.lib")
		#elif defined(_DLL)
			#pragma comment(lib, "clanSqlite-static-mtdll-debug.lib")
			#pragma comment(lib, "libpq-static-mtdll-debug.lib")
		#else
			#pragma comment(lib, "clanSqlite-static-mt-debug.lib")
			#pragma comment(lib, "libpq-static-mt-debug.lib")
		#endif
	#endif
#endif
